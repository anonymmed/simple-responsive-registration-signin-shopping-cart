    ...
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-5 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div style="padding-top:30px" class="panel-body">
                ...
                <form id="login" class="form-horizontal" role="form" action="../../index.php" method="post">
    ...
    <div id="signupbox" style="display:none; margin-top:50px"
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form id="signup" class="form-horizontal" role="form" action="../../index.php" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-9">
                            <input type="submit" name="signup" id="btn-signup" type="button" class="btn btn-info" value="Sign Up">
                        </div>
                    </div>
